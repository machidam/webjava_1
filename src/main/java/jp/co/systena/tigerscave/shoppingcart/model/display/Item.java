package jp.co.systena.tigerscave.shoppingcart.model.display;
...
public class Item {
    ...
    /** itemName1 */
    private String itemName1 = "めんべえ";

    /** itemName1 */
    private int itemPrice1 = 1000;

    /** itemId2 */
    private int itemId2 = 2;

    /** itemName2 */
    private String itemName2 = "とおりもん";

    /** itemName2 */
    private int itemPrice2 = 2000;

    /** itemId3 */
    private int itemId3 = 3;

    /** itemName3 */
    private String itemName3 = "とっとっとー";

    /** itemName3 */
    private int itemPrice3 = 3000;
